...
const stats = [
  ...
  { icon: HiCube, label: "AI Models", value: "6+", desc: "CNN, NLP, Spectrogram, Frame Analysis" },
      ...
      <section className="py-20 bg-dark-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              "PyTorch", "TensorFlow", "EfficientNet", "Transformers",
              "FastAPI", "React", "Tailwind CSS", "Chart.js",
              "librosa", "scikit-learn", "ReportLab", "OpenCV",
            ].map((tech) => (
              <span
                key={tech}
                className="px-5 py-2.5 glass-card text-dark-300 text-sm font-medium hover:text-primary-400 hover:border-primary-500/30 transition-all cursor-default"
              >
                {tech}
              </span>
            ))}
